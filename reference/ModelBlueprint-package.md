...
grouped residual diagnostics, all rendered as interactive Plotly charts.
Supports sequential model pipelines via mb_seq() and saves complete
model bundles (including H2O and XGBoost models) as portable archives.
