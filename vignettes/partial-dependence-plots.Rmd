...
For binary classification models, PDP values are probabilities. A PDP that
rises from 0.1 to 0.6 across the feature range means the model assigns
substantially higher probability of the positive class at higher feature values.
